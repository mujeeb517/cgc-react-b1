    ...
    return (<header>
        <nav className="flex bg-orange-500 text-white h-9 flow-root">
            ...
            <ul className="flex ml-4 float-right mr-4">
                <li className="p-1 hover:text-orange-600"><a href="">Home</a></li>
                <li className="p-1 hover:text-orange-600"><a href="">About</a></li>
                <li className="p-1 hover:text-orange-600"><a href="">Products</a></li>
                <li className="p-1 hover:text-orange-600"><a href="">Contact</a></li>
